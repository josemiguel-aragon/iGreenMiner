        ...
        VStack {
            ...
            Button("hola"){
                ...
                DispatchQueue.global().async {
                    let numberOfRepetitions = 1000 // Número de repeticiones que deseas hacer
                    ...
                    // Ocultar la alerta al finalizar la tarea
                      DispatchQueue.main.async {
                          showingAlert = true
                      }
                }
            }.alert(isPresented: $showingAlert) {
                Alert(title: Text("Tarea finalizada"), message: Text("La tarea en segundo plano ha finalizado"), dismissButton: .default(Text("Aceptar")))
            }
        }
    }
}
